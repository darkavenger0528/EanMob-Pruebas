...
const transporter = nodemailer.createTransport({
  ...
  secure: emailConfig.port === 465, // true solo para puerto 465
  auth: {
    ...
    <div style="font-family: Arial, sans-serif; max-width: 480px; margin: auto; border: 1px solid #e0e0e0; border-radius: 8px; overflow: hidden;">
      ...
      <div style="padding: 32px;">
        ...
        <div style="text-align: center; margin: 24px 0;">
          <span style="font-size: 40px; font-weight: bold; letter-spacing: 12px; color: #003366;">${otp}</span>
        </div>
        <p style="color: #888; font-size: 13px;">Este código expira en <strong>${expiryMinutes} minutos</strong>. No lo compartas con nadie.</p>
      </div>
      <div style="background-color: #f5f5f5; padding: 16px; text-align: center;">
        <p style="font-size: 12px; color: #aaa; margin: 0;">Si no solicitaste este código, ignora este mensaje.</p>
      </div>
    </div>
  `;
